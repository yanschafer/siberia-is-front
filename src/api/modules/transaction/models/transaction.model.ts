...
export default class TransactionModel extends ApiModelUtil {
  ...
  public async getAvailableFiltered(searchFilterDto: TransactionSearchFilterDto = new TransactionSearchFilterDto()): Promise<ApiResponseDto<TransactionListItemDto[]>> {
